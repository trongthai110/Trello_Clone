...
class LabelColorListItemsAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            holder.itemView.viewMain.setBackgroundColor(Color.parseColor(item))
            if (item == selectedColor) {
                holder.itemView.ivSelectedColor.visibility = View.VISIBLE
            } else {
                holder.itemView.ivSelectedColor.visibility = View.GONE
            }
